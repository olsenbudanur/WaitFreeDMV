...
import { Button, TextField, FormControl, InputLabel, Box, 
        Select, MenuItem, DialogContent} from '@mui/material';
import "./Styles.css";
...
const Appointment = () => {
  ...
  var types = ["Driver and ID Card Services", 
              "Learner's Permit / Knowledge Test", 
              "Road Skills Testing", 
              "Motorcyle Skills Testing", 
              "Hazmat Fingerprint / Background Check", 
              "E-ZPass"];
    ...
    <div>
      ...
      <div className='row'>
        ...
        <div className='column'>
          ...
          <div className='text'>
            <Button variant="contained" id="apptbtn">
          ...
          <div style={{padding:'10px'}}>
            <FormControl sx={{ m: 1, minWidth: '30%' }}>
              <TextField 
                id="standard-basic" 
                label="Deadline(# of weeks from now)" 
                type="number" 
                variant="outlined"
                value={time} 
